...
namespace ZPI.Persistance.ZPIDb.Migrations
{
    ...
    [Migration("20221205200023_AddMissingRelationsForUser")]
    partial class AddMissingRelationsForUser
    {
            ...
            modelBuilder.Entity("ZPI.Persistance.Entities.UserAssetEntity", b =>
                {
                    ...
                    b.HasKey("AssetIdentifier", "UserId", "Description");
            ...
            modelBuilder.Entity("ZPI.Persistance.Entities.WalletEntity", b =>
                {
                    ...
                    b.Property<LocalDate>("DateStamp")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("ZPI.Persistance.Entities.TransactionEntity", b =>
                {
                    ...
                    b.HasOne("ZPI.Persistance.Entities.UserPreferencesEntity", "User")
                        .WithMany("Transactions")
